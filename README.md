...
Library that performs static analysis of [Sui](https://sui.io/) [Programmable Transaction Blocks (PTBs)](https://docs.sui.io/concepts/transactions/prog-txn-blocks).
